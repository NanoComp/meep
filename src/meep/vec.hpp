...
inline bool is_E_or_D(component c) {return is_electric(component c)|| is_D(component c); }
inline bool is_H_or_B(component c) {return is_magnetic(component c)|| is_H(component c); }
