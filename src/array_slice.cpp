...
// true iv lies within the subgrid with min/max corners ivmin, ivmax
...
/**********************************************************************/
/* precisely one of fun, rfun should be non-NULL / true               */
/**********************************************************************/
...
cdouble *fields::get_source_slice(const volume &where, component source_slice_component,
 ...
 int rank=get_array_slice_dimensions(where, dims, dirs, collapse, false, min_max_loc);
