...
void harmonics(double freq, double chi2, double chi3, double J, double &A2, double &A3) {
  ...
  dft_flux d1 = f.add_dft_flux(Z, volume(fpt), freq, freq, 1, true, true, 1);
  dft_flux d2 = f.add_dft_flux(Z, volume(fpt), 2 * freq, 2 * freq, 1, true, true, 1);
  dft_flux d3 = f.add_dft_flux(Z, volume(fpt), 3 * freq, 3 * freq, 1, true, true, 1);
