...
in `MaterialGrid`s instead of as a user-defined preprocessing step; on the other hand, you should
have the additional projection (or directly plot $varepsilon$) to visualize the actual structure.
