...
The simulation script is in [examples/oblique-planewave.py](https://github.com/NanoComp/meep/blob/master/python/examples/oblique-planewave.py).
...
The field profiles at steady state generated by the planewave at three rotation angles in separate runs are shown below. Residues of the backward-propagating waves are again present.
