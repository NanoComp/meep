...
The simulation script is in [examples/refl-quartz.py](https://github.com/NanoComp/meep/blob/master/python/examples/refl-quartz.py). The notebook is [examples/refl-quartz.ipynb](https://github.com/NanoComp/meep/blob/master/python/examples/refl-quartz.ipynb).
