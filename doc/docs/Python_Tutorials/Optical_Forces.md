...
Note: the Maxwell stress tensor must always be computed in vacuum because the photon momenum is not well defined within dielectric media (see [Abraham–Minkowski controversy](https://en.wikipedia.org/wiki/Abraham%E2%80%93Minkowski_controversy)).
