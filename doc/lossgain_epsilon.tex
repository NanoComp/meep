...
\begin{verbatim}
  f.add_point_source(Ep, 0.13, 0.8, 0.0, 8.0, vec(rmax,sourceloc));
  f.add_point_source(Ep, 0.21, 0.8, 0.0, 8.0, vec(rmax,sourceloc));
  f.add_point_source(Ep, 0.3 , 0.8, 0.0, 8.0, vec(rmax,sourceloc));
  f.add_point_source(Ep, 0.43, 0.8, 0.0, 8.0, vec(rmax,sourceloc));
\end{verbatim}
\begin{comment}
