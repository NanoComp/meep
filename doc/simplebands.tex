...
are interested in.  dactyl makes this easy with a couple of ``fields_chunk''
methods, \verb-initialize_with_n_te-, and
\verb-initialize_with_n_tm-.  These initialize the field with the n
lowest TE and TM modes respectively.
...
copies the fields_chunk into the already allocated arrays for future use.
