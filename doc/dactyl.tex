...
fields_chunk to be of the form:
\begin{equation*}
...
in which some of the field components are split into two fields_chunk, each of
...
or more additional polarization fields_chunk, to be propogated along with the
...
split the electric and magnetic fields_chunk.
