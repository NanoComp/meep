...
int main(int argc, char *argv[])
{
  ...
  cdouble *coeffs= new cdouble[2*num_bands*num_freqs];
  double *vgrp = new double[num_bands*num_freqs];
  f.get_eigenmode_coefficients(fluxB, dB, *fvB, bands, num_bands, coeffs, vgrp);
