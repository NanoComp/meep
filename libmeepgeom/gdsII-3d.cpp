...
int main(int argc, char *argv[])
{
  ...
  geometric_object oxide_via_prism
   = meep_geom::get_GDSII_prism(meep_geom::vacuum, GDSIIFile, OXIDE_VIA_LAYER, OXIDE_ZMIN, OXIDE_ZMAX);
  ...
  volume v1=meep_geom::get_GDSII_volume(GDSIIFile, "yzplane", SLICE_LAYER, OXIDE_ZMIN, SILICON_ZMAX);
  volume v2=meep_geom::get_GDSII_volume(GDSIIFile, "xyplane", SLICE_LAYER, OXIDE_Z0, OXIDE_Z0);
  volume v3=meep_geom::get_GDSII_volume(GDSIIFile, "xyplane", SLICE_LAYER, SILICON_Z0, SILICON_Z0);
