...
class TestRing(unittest.TestCase):
    ...
    def test_harminv(self):
        ...
        self.assertAlmostEqual(m1.freq, 0.118101315147, places=6)
        self.assertAlmostEqual(m1.decay, -0.000731513241623, places=5)
        self.assertAlmostEqual(abs(m1.amp), 0.00341267634436, places=5)
        self.assertAlmostEqual(m1.amp.real, -0.00304951667301, places=5)
        self.assertAlmostEqual(m1.amp.imag, -0.00153192946717, places=5)
