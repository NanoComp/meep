...
class TestModeSolver(unittest.TestCase):
    ...
    def check_band_range_data(self, expected_brd, result, places=3, tol=1e-3):
        for exp, res in zip(expected_brd, result):
            ...
            # Compare min k
            msg = "expected {}, got {}"
            self.assertTrue(exp[0][1].close(res[0][1], tol=tol), msg=msg.format(exp[0][1],
                                                                                res[0][1]))
            # Compare max freqs
            self.assertAlmostEqual(exp[1][0], res[1][0], places=places)
            # Compare max k
            self.assertTrue(exp[1][1].close(res[1][1], tol=tol), msg=msg.format(exp[1][1],
                                                                                res[1][1]))
    ...
    def test_run_te(self):
        ...
        expected_freqs = [0.0, 0.554312283650418, 0.7744332017916128, 0.7744499139497024,
                          0.9235813707319223, 1.0008466887820455, 1.000853628619655,
                          1.0937421482650005]
        ...
        expected_brd = [
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.4983278408634563, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.4424096269285014, mp.Vector3(0.5, 0.0, 0.0)),
             (0.5932903602196976, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.5933300393525752, mp.Vector3(0.5, 0.5, 0.0)),
             (0.7744332017916128, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.6789328329224144, mp.Vector3(0.5, 0.5, 0.0)),
             (0.810789850817525, mp.Vector3(0.30000000000000004, 0.30000000000000004, 0.0))),
            ((0.8255441820087417, mp.Vector3(0.5, 0.30000000000000004, 0.0)),
             (0.9235813707319223, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.8843176478465046, mp.Vector3(0.5, 0.5, 0.0)),
             (1.0289817388673197, mp.Vector3(0.5, 0.0, 0.0))),
            ((0.8843467564121597, mp.Vector3(0.5, 0.5, 0.0)),
             (1.0865986604762512, mp.Vector3(0.5, 0.0, 0.0))),
            ((1.0882480224788622, mp.Vector3(0.5, 0.0, 0.0)),
             (1.1123375888057576, mp.Vector3(0.5, 0.5, 0.0))),
        ]

        expected_gap_list = [
            (0.006687755054929978, 0.5932903602196976, 0.5933300393525752),
            (1.8033397699042075, 0.810789850817525, 0.8255441820087417),
            (0.15167616324750843, 1.0865986604762512, 1.0882480224788622),
        ]
    ...
    def test_run_tm(self):
        expected_brd = [
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.28124178486425067, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.41769014662393533, mp.Vector3(0.5, 0.0, 0.0)),
             (0.546017096316291, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.49700744330657826, mp.Vector3(0.5, 0.5, 0.0)),
             (0.5585358594734681, mp.Vector3(0.5, 0.0, 0.0))),
            ((0.5529886289239748, mp.Vector3(0.0, 0.0, 0.0)),
             (0.7134781269284286, mp.Vector3(0.5, 0.0, 0.0))),
            ((0.7417611092765056, mp.Vector3(0.5, 0.0, 0.0)),
             (0.8593597930211467, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.8295123010033769, mp.Vector3(0.30000000000000004, 0.30000000000000004, 0.0)),
             (0.8783083849584135, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.862729996589617, mp.Vector3(0.5, 0.0, 0.0)),
             (0.952293063301956, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.8809282925396458, mp.Vector3(0.5, 0.5, 0.0)),
             (1.0840698978784298, mp.Vector3(0.0, 0.0, 0.0))),
        ]
    ...
    def test_triangular_lattice(self):
        ...
        expected_brd = [
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.27418366423239254, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0))),
            ((0.4443772343486368, mp.Vector3(0.0, 0.5, 0.0)),
             (0.558924251719436, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.4890716303894442, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0)),
             (0.5590346465294709, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.5933240873398963, mp.Vector3(0.0, 0.0, 0.0)),
             (0.7895347544317188, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0))),
            ((0.7896048751321955, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0)),
             (0.8347553810263939, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.8348898395493585, mp.Vector3(0.0, 0.0, 0.0)),
             (0.8651618822376882, mp.Vector3(-0.2, 0.39999999999999997, 0.0))),
            ((0.8669299142295027, mp.Vector3(-0.13333333333333336, 0.4333333333333333, 0.0)),
             (0.9918056985442391, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.8973819265132584, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0)),
             (1.0937048594788943, mp.Vector3(0.0, 0.0, 0.0))),
        ]
    ...
    def test_maximize_first_tm_gap(self):
        ...
        expected = 39.10065043582974
        self.assertAlmostEqual(expected, result.fun * -1, places=3)
    ...
    def test_point_defect_state(self):
        ...
        self.assertAlmostEqual(0.6202741053491893, e, places=3)
        ...
        self.assertAlmostEqual(5.221288723644521, rooteps, places=3)
        self.assertAlmostEqual(1.1874461136596182e-8, rootval, places=3)
    ...
    def test_diamond(self):
        ...
        expected_brd = [
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.3943579308259146, mp.Vector3(0.25, 0.75, 0.5))),
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.39658490589278406, mp.Vector3(0.29999999999999993, 0.75, 0.45000000000000007))),
            ((0.44191473403818504, mp.Vector3(0.0, 0.5, 0.0)),
             (0.5961986882121378, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.4437128006357467, mp.Vector3(0.0, 0.5, 0.0)),
             (0.5962884278077665, mp.Vector3(0.0, 0.0, 0.0))),
    ...
    def test_honey_rods(self):
        ...
        expected_tm_brd = [
            ((0.0, mp.Vector3()),
             (0.33603917043712633, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0))),
            ((0.3361157598278567, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0)),
             (0.43081437569409614, mp.Vector3())),
            ((0.5767097297514042, mp.Vector3(-0.3333333333333333, 0.3333333333333333, 0.0)),
             (0.7284078808050087, mp.Vector3())),
            ((0.6945421679868867, mp.Vector3(y=0.5)),
             (0.7501709691499355, mp.Vector3(-0.3333333333333333, 0.3333333333333333))),
            ((0.7458435049833266, mp.Vector3(-0.06666666666666667, 0.06666666666666667, 0.0)),
             (0.7820399146771551, mp.Vector3(y=0.5))),
            ((0.7881649319901423, mp.Vector3()),
             (0.8222343753655029, mp.Vector3(-0.3333333333333333, 0.3333333333333333))),
            ((0.788403686482661, mp.Vector3()),
             (0.9137151502979921, mp.Vector3(y=0.5))),
            ((1.0555583895998264, mp.Vector3(y=0.5)),
             (1.152788234165643, mp.Vector3())),
        ]
        ...
        expected_te_brd = [
            ((0.0, mp.Vector3()),
             (0.5541825355101483, mp.Vector3(-0.3333333333333333, 0.3333333333333333))),
            ((0.5210838392763666, mp.Vector3(y=0.5)),
             (0.7314488357699701, mp.Vector3())),
            ((0.5774131466802845, mp.Vector3(-0.3333333333333333, 0.3333333333333333)),
             (0.7914367245833008, mp.Vector3())),
            ((0.8171437726482415, mp.Vector3(y=0.5)),
             (0.9223035157967082, mp.Vector3())),
            ((0.8412299566295994, mp.Vector3(-0.3333333333333333, 0.3333333333333333)),
             (0.9232816589081834, mp.Vector3())),
            ((1.0189688220301099, mp.Vector3()),
             (1.1102151203212018, mp.Vector3(-0.3333333333333333, 0.3333333333333333))),
            ((1.0202591321478567, mp.Vector3()),
             (1.1645809975920867, mp.Vector3(-0.3333333333333333, 0.3333333333333333))),
            ((1.1678724079900584, mp.Vector3(-0.2, 0.2)),
             (1.245166619435556, mp.Vector3())),
        ]
    ...
    def test_sq_rods(self):
        ...
        expected_te_brd = [
            ((0.0, mp.Vector3()),
             (0.5050847157964128, mp.Vector3(0.5, 0.5))),
            ((0.44540649255863274, mp.Vector3(0.5)),
             (0.5944938855425008, mp.Vector3(0.5, 0.5))),
            ((0.594532293207845, mp.Vector3(0.5, 0.5)),
             (0.7819718899089974, mp.Vector3())),
            ((0.6791640707712324, mp.Vector3(0.5, 0.5)),
             (0.8179936626803539, mp.Vector3(0.30000000000000004, 0.30000000000000004))),
            ((0.8312976217063687, mp.Vector3(0.30000000000000004, 0.30000000000000004, 0.0)),
             (0.9249830180346097, mp.Vector3())),
            ((0.8981377255346836, mp.Vector3(0.5, 0.5)),
             (1.0328365492796805, mp.Vector3(0.5, 0.0))),
            ((0.8981669079842797, mp.Vector3(0.5, 0.5)),
             (1.0962585283583286, mp.Vector3(0.5, 0.0))),
            ((1.0979727446260454, mp.Vector3(0.5)),
             (1.1284502813494561, mp.Vector3(0.5, 0.5))),
        ]
        ...
        expected_tm_brd = [
            ((0.0, mp.Vector3(0.0, 0.0, 0.0)),
             (0.28620353092376244, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.4212205919470541, mp.Vector3(0.5, 0.0, 0.0)),
             (0.55032328617865, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.5037942789367704, mp.Vector3(0.5, 0.5, 0.0)),
             (0.5680541609705985, mp.Vector3(0.5, 0.0, 0.0))),
            ((0.5622452000444543, mp.Vector3(0.0, 0.0, 0.0)),
             (0.7201952790771862, mp.Vector3(0.5, 0.0, 0.0))),
            ((0.7476247632855232, mp.Vector3(0.5, 0.0, 0.0)),
             (0.8742488320227753, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.8404563836725962, mp.Vector3(0.30000000000000004, 0.30000000000000004, 0.0)),
             (0.8833020711235466, mp.Vector3(0.5, 0.5, 0.0))),
            ((0.8772216067719807, mp.Vector3(0.5, 0.0, 0.0)),
             (0.9665386468333201, mp.Vector3(0.0, 0.0, 0.0))),
            ((0.8945799356827068, mp.Vector3(0.5, 0.5, 0.0)),
             (1.090651920052584, mp.Vector3(0.0, 0.0, 0.0))),
        ]
