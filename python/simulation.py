...
class Simulation(object):
    ...
    def _init_structure(self, k=False):
        ...
        self.structure = mp.structure(gv, None, br, sym, self.num_chunks, self.Courant, self.eps_averaging,
                                      self.subpixel_tol, self.subpixel_maxeval,
                                      mp.FragmentStatsVector([fs for fs in self.fragment_stats]))
