...
do
  ...
  # python ../../ring-cyl-perturbation-theory.py -perp True -res $RESOLUTION -dr $DR | grep -e component: -e res: -e dr: -e w: -e dwdR: > pring-cyl-perturbation-theory.Hz.perp_True_res_${RESOLUTION}_dr_${DR}.dat
done
